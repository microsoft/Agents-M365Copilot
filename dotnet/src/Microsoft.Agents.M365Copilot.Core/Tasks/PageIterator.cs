...
namespace Microsoft.Agents.M365Copilot.Core.Tasks
{
    ...
    */
...
#endif
    {
        ...
        /// <param name="page">A generated implementation of ICollectionPage.</param>
        /// <param name="asyncCallback">A Func delegate that processes type TEntity in the result set asynchronously and should return false if the iterator should cancel processing.</param>
        /// <param name="requestConfigurator">A Func delegate that configures the NextPageRequest</param>
        /// <param name="errorMapping">The error mappings to use in case of failed request during page iteration</param>
        /// <returns>A PageIterator&lt;TEntity&gt; that will process additional result pages based on the rules specified in Func&lt;TEntity,bool&gt; processPageItems</returns>
        ...
        /// <exception cref="Exceptions.ServiceException">Thrown when the service encounters an error with
        /// a request.</exception>
...
#pragma warning restore CS1587
    ...
    {
        /// <summary>
        /// The iterator has neither started iterating through the initial page nor request more pages.
        /// </summary>
        NotStarted,
        /// <summary>
        /// The callback returned false or a cancellation token was set. The iterator is resumable.
        /// </summary>
        Paused,
        /// <summary>
        ...
        InterpageIteration,
        /// <summary>
        /// A deltaToken was returned. The iterator is resumable.
        /// </summary>
        Delta,
        /// <summary>
