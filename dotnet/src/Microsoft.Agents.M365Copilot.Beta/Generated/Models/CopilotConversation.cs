...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Microsoft.Agents.M365Copilot.Beta.Models.CopilotConversationMessage>? Messages { get; set; }
#nullable restore
#else
        public List<global::Microsoft.Agents.M365Copilot.Beta.Models.CopilotConversationMessage> Messages { get; set; }
#endif
        /// <summary>The state of a Copilot conversation.</summary>
        public global::Microsoft.Agents.M365Copilot.Beta.Models.CopilotConversationState? State { get; set; }
