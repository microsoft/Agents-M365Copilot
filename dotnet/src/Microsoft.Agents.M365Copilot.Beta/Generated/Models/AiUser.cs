...
#nullable enable
        public global::Microsoft.Agents.M365Copilot.Beta.Models.AiInteractionHistory? InteractionHistory { get; set; }
#nullable restore
#else
        public global::Microsoft.Agents.M365Copilot.Beta.Models.AiInteractionHistory InteractionHistory { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Microsoft.Agents.M365Copilot.Beta.Models.AiOnlineMeeting>? OnlineMeetings { get; set; }
#nullable restore
#else
        public List<global::Microsoft.Agents.M365Copilot.Beta.Models.AiOnlineMeeting> OnlineMeetings { get; set; }
#endif
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "onlineMeetings", n => { OnlineMeetings = n.GetCollectionOfObjectValues<global::Microsoft.Agents.M365Copilot.Beta.Models.AiOnlineMeeting>(global::Microsoft.Agents.M365Copilot.Beta.Models.AiOnlineMeeting.CreateFromDiscriminatorValue)?.AsList(); } },
            };
        }
        /// <summary>
