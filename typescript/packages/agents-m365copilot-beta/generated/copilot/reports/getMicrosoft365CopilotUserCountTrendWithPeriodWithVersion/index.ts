 ...
 */
export const GetMicrosoft365CopilotUserCountTrendWithPeriodWithVersionRequestBuilderUriTemplate = "{+baseurl}/copilot/reports/getMicrosoft365CopilotUserCountTrend(period='{period}',version='{version}')";
/**
