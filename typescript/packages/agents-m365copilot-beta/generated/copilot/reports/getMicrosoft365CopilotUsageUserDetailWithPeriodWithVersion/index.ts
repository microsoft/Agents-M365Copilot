 ...
 */
export const GetMicrosoft365CopilotUsageUserDetailWithPeriodWithVersionRequestBuilderUriTemplate = "{+baseurl}/copilot/reports/getMicrosoft365CopilotUsageUserDetail(period='{period}',version='{version}')";
/**
