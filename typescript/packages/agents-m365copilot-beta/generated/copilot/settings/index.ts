...
// @ts-ignore
import { createCopilotSettingFromDiscriminatorValue, serializeCopilotSetting, type CopilotSetting } from '../../models/index.js';
// @ts-ignore
...
export interface SettingsRequestBuilder extends BaseRequestBuilder<SettingsRequestBuilder> {
     ...
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     * @returns {Promise<CopilotSetting>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     */
     get(requestConfiguration?: RequestConfiguration<SettingsRequestBuilderGetQueryParameters> | undefined) : Promise<CopilotSetting | undefined>;
    /**
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     */
     patch(body: CopilotSetting, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<CopilotSetting | undefined>;
    /**
     * Delete navigation property settings for copilot
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     ...
     * @returns {RequestInformation}
     */
     toPatchRequestInformation(body: CopilotSetting, requestConfiguration?: RequestConfiguration<object> | undefined) : RequestInformation;
}
/**
 * Get settings from copilot
 */
...
export const SettingsRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        uriTemplate: "{+baseurl}/copilot/settings{?%24expand,%24select}",
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
        adapterMethodName: "send",
        responseBodyFactory:  createCopilotSettingFromDiscriminatorValue,
    ...
    patch: {
        ...
        requestBodySerializer: serializeCopilotSetting,
