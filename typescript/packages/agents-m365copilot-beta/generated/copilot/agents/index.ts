...
// @ts-ignore
import { createAgentCollectionResponseFromDiscriminatorValue, type AgentCollectionResponse } from '../../models/index.js';
// @ts-ignore
import { createODataErrorFromDiscriminatorValue, type ODataError } from '../../models/oDataErrors/index.js';
// @ts-ignore
import { CountRequestBuilderRequestsMetadata, type CountRequestBuilder } from './count/index.js';
// @ts-ignore
import { AgentItemRequestBuilderRequestsMetadata, type AgentItemRequestBuilder } from './item/index.js';
// @ts-ignore
...
export interface AgentsRequestBuilder extends BaseRequestBuilder<AgentsRequestBuilder> {
     ...
     */
     byAgentId(agentId: string) : AgentItemRequestBuilder;
    /**
     * Get agents from copilot
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     * @returns {Promise<AgentCollectionResponse>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     */
     get(requestConfiguration?: RequestConfiguration<AgentsRequestBuilderGetQueryParameters> | undefined) : Promise<AgentCollectionResponse | undefined>;
    /**
     * Get agents from copilot
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
 ...
 */
export const AgentsRequestBuilderUriTemplate = "{+baseurl}/copilot/agents{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
...
export const AgentsRequestBuilderNavigationMetadata: Record<Exclude<keyof AgentsRequestBuilder, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    byAgentId: {
        requestsMetadata: AgentItemRequestBuilderRequestsMetadata,
        pathParametersMappings: ["agent%2Did"],
    },
    count: {
...
export const AgentsRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        ...
        responseBodyFactory:  createAgentCollectionResponseFromDiscriminatorValue,
