...
export function deserializeIntoAiInteraction(aiInteraction: Partial<AiInteraction> | undefined = {}): Record<string, (node: ParseNode) => void> {
	return {
		...
		appClass: (n) => {
			aiInteraction.appClass = n.getStringValue();
		},
		attachments: (n) => {
			aiInteraction.attachments = n.getCollectionOfObjectValues<AiInteractionAttachment>(createAiInteractionAttachmentFromDiscriminatorValue);
		},
		body: (n) => {
			aiInteraction.body = n.getObjectValue<ItemBody>(createItemBodyFromDiscriminatorValue);
		},
		contexts: (n) => {
			aiInteraction.contexts = n.getCollectionOfObjectValues<AiInteractionContext>(createAiInteractionContextFromDiscriminatorValue);
		},
		conversationType: (n) => {
			aiInteraction.conversationType = n.getStringValue();
		},
		createdDateTime: (n) => {
			aiInteraction.createdDateTime = n.getDateValue();
		},
		etag: (n) => {
			aiInteraction.etag = n.getStringValue();
		},
		from: (n) => {
			aiInteraction.from = n.getObjectValue<IdentitySet>(createIdentitySetFromDiscriminatorValue);
		},
		interactionType: (n) => {
			aiInteraction.interactionType = n.getEnumValue<AiInteractionType>(AiInteractionTypeObject);
		},
		links: (n) => {
			aiInteraction.links = n.getCollectionOfObjectValues<AiInteractionLink>(createAiInteractionLinkFromDiscriminatorValue);
		},
		locale: (n) => {
			aiInteraction.locale = n.getStringValue();
		},
		mentions: (n) => {
			aiInteraction.mentions = n.getCollectionOfObjectValues<AiInteractionMention>(createAiInteractionMentionFromDiscriminatorValue);
		},
		requestId: (n) => {
			aiInteraction.requestId = n.getStringValue();
		},
		sessionId: (n) => {
			aiInteraction.sessionId = n.getStringValue();
		},
	};
}
/**
...
export function deserializeIntoAiInteractionAttachment(aiInteractionAttachment: Partial<AiInteractionAttachment> | undefined = {}): Record<string, (node: ParseNode) => void> {
	return {
		attachmentId: (n) => {
			aiInteractionAttachment.attachmentId = n.getStringValue();
		},
		backingStoreEnabled: (n) => {
			aiInteractionAttachment.backingStoreEnabled = true;
		},
		content: (n) => {
			aiInteractionAttachment.content = n.getStringValue();
		},
		contentType: (n) => {
			aiInteractionAttachment.contentType = n.getStringValue();
		},
		contentUrl: (n) => {
			aiInteractionAttachment.contentUrl = n.getStringValue();
		},
		name: (n) => {
			aiInteractionAttachment.name = n.getStringValue();
		},
		"@odata.type": (n) => {
			aiInteractionAttachment.odataType = n.getStringValue();
		},
		teamsAppId: (n) => {
			aiInteractionAttachment.teamsAppId = n.getStringValue();
		},
		thumbnailUrl: (n) => {
			aiInteractionAttachment.thumbnailUrl = n.getStringValue();
		},
	};
}
/**
...
export function deserializeIntoAiInteractionCollectionResponse(aiInteractionCollectionResponse: Partial<AiInteractionCollectionResponse> | undefined = {}): Record<string, (node: ParseNode) => void> {
	return {
		...
		value: (n) => {
			aiInteractionCollectionResponse.value = n.getCollectionOfObjectValues<AiInteraction>(createAiInteractionFromDiscriminatorValue);
		},
	};
}
/**
...
export function deserializeIntoAiInteractionContext(aiInteractionContext: Partial<AiInteractionContext> | undefined = {}): Record<string, (node: ParseNode) => void> {
	return {
		backingStoreEnabled: (n) => {
			aiInteractionContext.backingStoreEnabled = true;
		},
		contextReference: (n) => {
			aiInteractionContext.contextReference = n.getStringValue();
		},
		contextType: (n) => {
			aiInteractionContext.contextType = n.getStringValue();
		},
		displayName: (n) => {
			aiInteractionContext.displayName = n.getStringValue();
		},
		"@odata.type": (n) => {
			aiInteractionContext.odataType = n.getStringValue();
		},
	};
}
/**
...
export function deserializeIntoAiInteractionHistory(aiInteractionHistory: Partial<AiInteractionHistory> | undefined = {}): Record<string, (node: ParseNode) => void> {
	return {
		...
		interactions: (n) => {
			aiInteractionHistory.interactions = n.getCollectionOfObjectValues<AiInteraction>(createAiInteractionFromDiscriminatorValue);
		},
	};
}
/**
...
export function deserializeIntoAiInteractionLink(aiInteractionLink: Partial<AiInteractionLink> | undefined = {}): Record<string, (node: ParseNode) => void> {
	return {
		backingStoreEnabled: (n) => {
			aiInteractionLink.backingStoreEnabled = true;
		},
		displayName: (n) => {
			aiInteractionLink.displayName = n.getStringValue();
		},
		linkType: (n) => {
			aiInteractionLink.linkType = n.getStringValue();
		},
		linkUrl: (n) => {
			aiInteractionLink.linkUrl = n.getStringValue();
		},
		"@odata.type": (n) => {
			aiInteractionLink.odataType = n.getStringValue();
		},
	};
}
/**
...
export function deserializeIntoAiInteractionMention(aiInteractionMention: Partial<AiInteractionMention> | undefined = {}): Record<string, (node: ParseNode) => void> {
	return {
		backingStoreEnabled: (n) => {
			aiInteractionMention.backingStoreEnabled = true;
		},
		mentioned: (n) => {
			aiInteractionMention.mentioned = n.getObjectValue<AiInteractionMentionedIdentitySet>(createAiInteractionMentionedIdentitySetFromDiscriminatorValue);
		},
		mentionId: (n) => {
			aiInteractionMention.mentionId = n.getNumberValue();
		},
		mentionText: (n) => {
			aiInteractionMention.mentionText = n.getStringValue();
		},
		"@odata.type": (n) => {
			aiInteractionMention.odataType = n.getStringValue();
		},
	};
}
/**
...
export function deserializeIntoAiInteractionMentionedIdentitySet(aiInteractionMentionedIdentitySet: Partial<AiInteractionMentionedIdentitySet> | undefined = {}): Record<string, (node: ParseNode) => void> {
	return {
		...
		conversation: (n) => {
			aiInteractionMentionedIdentitySet.conversation = n.getObjectValue<TeamworkConversationIdentity>(createTeamworkConversationIdentityFromDiscriminatorValue);
		},
		tag: (n) => {
			aiInteractionMentionedIdentitySet.tag = n.getObjectValue<TeamworkTagIdentity>(createTeamworkTagIdentityFromDiscriminatorValue);
		},
	};
}
/**
...
export function deserializeIntoAiUser(aiUser: Partial<AiUser> | undefined = {}): Record<string, (node: ParseNode) => void> {
	return {
		...
		interactionHistory: (n) => {
			aiUser.interactionHistory = n.getObjectValue<AiInteractionHistory>(createAiInteractionHistoryFromDiscriminatorValue);
		},
	};
}
/**
...
export function deserializeIntoAiUserCollectionResponse(aiUserCollectionResponse: Partial<AiUserCollectionResponse> | undefined = {}): Record<string, (node: ParseNode) => void> {
	return {
		...
		value: (n) => {
			aiUserCollectionResponse.value = n.getCollectionOfObjectValues<AiUser>(createAiUserFromDiscriminatorValue);
		},
	};
}
/**
...
export function deserializeIntoApprovalIdentitySet(approvalIdentitySet: Partial<ApprovalIdentitySet> | undefined = {}): Record<string, (node: ParseNode) => void> {
	return {
		...
		group: (n) => {
			approvalIdentitySet.group = n.getObjectValue<Identity>(createIdentityFromDiscriminatorValue);
		},
	};
}
/**
...
export function deserializeIntoAuditUserIdentity(auditUserIdentity: Partial<AuditUserIdentity> | undefined = {}): Record<string, (node: ParseNode) => void> {
	return {
		...
		homeTenantId: (n) => {
			auditUserIdentity.homeTenantId = n.getStringValue();
		},
		homeTenantName: (n) => {
			auditUserIdentity.homeTenantName = n.getStringValue();
		},
	};
}
/**
...
export function deserializeIntoAzureCommunicationServicesUserIdentity(azureCommunicationServicesUserIdentity: Partial<AzureCommunicationServicesUserIdentity> | undefined = {}): Record<string, (node: ParseNode) => void> {
	return {
		...
		azureCommunicationServicesResourceId: (n) => {
			azureCommunicationServicesUserIdentity.azureCommunicationServicesResourceId = n.getStringValue();
		},
	};
}
/**
...
export function deserializeIntoBaseCollectionPaginationCountResponse(baseCollectionPaginationCountResponse: Partial<BaseCollectionPaginationCountResponse> | undefined = {}): Record<string, (node: ParseNode) => void> {
	return {
		backingStoreEnabled: (n) => {
			baseCollectionPaginationCountResponse.backingStoreEnabled = true;
		},
		"@odata.count": (n) => {
			baseCollectionPaginationCountResponse.odataCount = n.getNumberValue();
		},
		"@odata.nextLink": (n) => {
			baseCollectionPaginationCountResponse.odataNextLink = n.getStringValue();
		},
	};
}
/**
...
export function deserializeIntoChatMessageMentionedIdentitySet(chatMessageMentionedIdentitySet: Partial<ChatMessageMentionedIdentitySet> | undefined = {}): Record<string, (node: ParseNode) => void> {
	return {
		...
		conversation: (n) => {
			chatMessageMentionedIdentitySet.conversation = n.getObjectValue<TeamworkConversationIdentity>(createTeamworkConversationIdentityFromDiscriminatorValue);
		},
		tag: (n) => {
			chatMessageMentionedIdentitySet.tag = n.getObjectValue<TeamworkTagIdentity>(createTeamworkTagIdentityFromDiscriminatorValue);
		},
	};
}
/**
...
export function deserializeIntoCommunicationsApplicationIdentity(communicationsApplicationIdentity: Partial<CommunicationsApplicationIdentity> | undefined = {}): Record<string, (node: ParseNode) => void> {
	return {
		...
		applicationType: (n) => {
			communicationsApplicationIdentity.applicationType = n.getStringValue();
		},
		hidden: (n) => {
			communicationsApplicationIdentity.hidden = n.getBooleanValue();
		},
	};
}
/**
...
export function deserializeIntoCommunicationsApplicationInstanceIdentity(communicationsApplicationInstanceIdentity: Partial<CommunicationsApplicationInstanceIdentity> | undefined = {}): Record<string, (node: ParseNode) => void> {
	return {
		...
		hidden: (n) => {
			communicationsApplicationInstanceIdentity.hidden = n.getBooleanValue();
		},
		tenantId: (n) => {
			communicationsApplicationInstanceIdentity.tenantId = n.getStringValue();
		},
	};
}
/**
...
export function deserializeIntoCommunicationsGuestIdentity(communicationsGuestIdentity: Partial<CommunicationsGuestIdentity> | undefined = {}): Record<string, (node: ParseNode) => void> {
	return {
		...
		email: (n) => {
			communicationsGuestIdentity.email = n.getStringValue();
		},
	};
}
/**
...
export function deserializeIntoCommunicationsIdentitySet(communicationsIdentitySet: Partial<CommunicationsIdentitySet> | undefined = {}): Record<string, (node: ParseNode) => void> {
	return {
		...
		applicationInstance: (n) => {
			communicationsIdentitySet.applicationInstance = n.getObjectValue<Identity>(createIdentityFromDiscriminatorValue);
		},
		assertedIdentity: (n) => {
			communicationsIdentitySet.assertedIdentity = n.getObjectValue<Identity>(createIdentityFromDiscriminatorValue);
		},
		azureCommunicationServicesUser: (n) => {
			communicationsIdentitySet.azureCommunicationServicesUser = n.getObjectValue<Identity>(createIdentityFromDiscriminatorValue);
		},
		encrypted: (n) => {
			communicationsIdentitySet.encrypted = n.getObjectValue<Identity>(createIdentityFromDiscriminatorValue);
		},
		endpointType: (n) => {
			communicationsIdentitySet.endpointType = n.getEnumValue<EndpointType>(EndpointTypeObject);
		},
		guest: (n) => {
			communicationsIdentitySet.guest = n.getObjectValue<Identity>(createIdentityFromDiscriminatorValue);
		},
		onPremises: (n) => {
			communicationsIdentitySet.onPremises = n.getObjectValue<Identity>(createIdentityFromDiscriminatorValue);
		},
		phone: (n) => {
			communicationsIdentitySet.phone = n.getObjectValue<Identity>(createIdentityFromDiscriminatorValue);
		},
	};
}
/**
...
export function deserializeIntoCommunicationsUserIdentity(communicationsUserIdentity: Partial<CommunicationsUserIdentity> | undefined = {}): Record<string, (node: ParseNode) => void> {
	return {
		...
		tenantId: (n) => {
			communicationsUserIdentity.tenantId = n.getStringValue();
		},
	};
}
/**
...
export function deserializeIntoCopilotAdmin(copilotAdmin: Partial<CopilotAdmin> | undefined = {}): Record<string, (node: ParseNode) => void> {
	return {
		...
		settings: (n) => {
			copilotAdmin.settings = n.getObjectValue<CopilotAdminSetting>(createCopilotAdminSettingFromDiscriminatorValue);
		},
	};
}
/**
...
export function deserializeIntoCopilotAdminLimitedMode(copilotAdminLimitedMode: Partial<CopilotAdminLimitedMode> | undefined = {}): Record<string, (node: ParseNode) => void> {
	return {
		...
		groupId: (n) => {
			copilotAdminLimitedMode.groupId = n.getStringValue();
		},
		isEnabledForGroup: (n) => {
			copilotAdminLimitedMode.isEnabledForGroup = n.getBooleanValue();
		},
	};
}
/**
...
export function deserializeIntoCopilotAdminSetting(copilotAdminSetting: Partial<CopilotAdminSetting> | undefined = {}): Record<string, (node: ParseNode) => void> {
	return {
		...
		limitedMode: (n) => {
			copilotAdminSetting.limitedMode = n.getObjectValue<CopilotAdminLimitedMode>(createCopilotAdminLimitedModeFromDiscriminatorValue);
		},
	};
}
/**
...
export function deserializeIntoDetailsInfo(detailsInfo: Partial<DetailsInfo> | undefined = {}): Record<string, (node: ParseNode) => void> {
	return {
		backingStoreEnabled: (n) => {
			detailsInfo.backingStoreEnabled = true;
		},
		"@odata.type": (n) => {
			detailsInfo.odataType = n.getStringValue();
		},
	};
}
/**
...
export function deserializeIntoDictionaries(dictionaries: Partial<Dictionaries> | undefined = {}): Record<string, (node: ParseNode) => void> {
	return {
		backingStoreEnabled: (n) => {
			dictionaries.backingStoreEnabled = true;
		},
		"@odata.type": (n) => {
			dictionaries.odataType = n.getStringValue();
		},
	};
}
/**
...
export function deserializeIntoEmailIdentity(emailIdentity: Partial<EmailIdentity> | undefined = {}): Record<string, (node: ParseNode) => void> {
	return {
		...
		email: (n) => {
			emailIdentity.email = n.getStringValue();
		},
	};
}
/**
...
export function deserializeIntoEngagementIdentitySet(engagementIdentitySet: Partial<EngagementIdentitySet> | undefined = {}): Record<string, (node: ParseNode) => void> {
	return {
		...
		audience: (n) => {
			engagementIdentitySet.audience = n.getObjectValue<Identity>(createIdentityFromDiscriminatorValue);
		},
		group: (n) => {
			engagementIdentitySet.group = n.getObjectValue<Identity>(createIdentityFromDiscriminatorValue);
		},
	};
}
/**
...
export function deserializeIntoEntity(entity: Partial<Entity> | undefined = {}): Record<string, (node: ParseNode) => void> {
	return {
		backingStoreEnabled: (n) => {
			entity.backingStoreEnabled = true;
		},
		id: (n) => {
			entity.id = n.getStringValue();
		},
		"@odata.type": (n) => {
			entity.odataType = n.getStringValue();
		},
	};
}
/**
...
export function deserializeIntoIdentity(identity: Partial<Identity> | undefined = {}): Record<string, (node: ParseNode) => void> {
	return {
		backingStoreEnabled: (n) => {
			identity.backingStoreEnabled = true;
		},
		displayName: (n) => {
			identity.displayName = n.getStringValue();
		},
		id: (n) => {
			identity.id = n.getStringValue();
		},
		"@odata.type": (n) => {
			identity.odataType = n.getStringValue();
		},
	};
}
/**
...
export function deserializeIntoIdentitySet(identitySet: Partial<IdentitySet> | undefined = {}): Record<string, (node: ParseNode) => void> {
	return {
		application: (n) => {
			identitySet.application = n.getObjectValue<Identity>(createIdentityFromDiscriminatorValue);
		},
		backingStoreEnabled: (n) => {
			identitySet.backingStoreEnabled = true;
		},
		device: (n) => {
			identitySet.device = n.getObjectValue<Identity>(createIdentityFromDiscriminatorValue);
		},
		"@odata.type": (n) => {
			identitySet.odataType = n.getStringValue();
		},
		user: (n) => {
			identitySet.user = n.getObjectValue<Identity>(createIdentityFromDiscriminatorValue);
		},
	};
}
/**
...
export function deserializeIntoInitiator(initiator: Partial<Initiator> | undefined = {}): Record<string, (node: ParseNode) => void> {
	return {
		...
		initiatorType: (n) => {
			initiator.initiatorType = n.getEnumValue<InitiatorType>(InitiatorTypeObject);
		},
	};
}
/**
...
export function deserializeIntoItemBody(itemBody: Partial<ItemBody> | undefined = {}): Record<string, (node: ParseNode) => void> {
	return {
		backingStoreEnabled: (n) => {
			itemBody.backingStoreEnabled = true;
		},
		content: (n) => {
		...
		"@odata.type": (n) => {
			itemBody.odataType = n.getStringValue();
		},
	};
}
/**
...
export function deserializeIntoKeyValuePair(keyValuePair: Partial<KeyValuePair> | undefined = {}): Record<string, (node: ParseNode) => void> {
	return {
		backingStoreEnabled: (n) => {
			keyValuePair.backingStoreEnabled = true;
		},
		name: (n) => {
			keyValuePair.name = n.getStringValue();
		},
		"@odata.type": (n) => {
			keyValuePair.odataType = n.getStringValue();
		},
		value: (n) => {
			keyValuePair.value = n.getStringValue();
		},
	};
}
/**
...
export function deserializeIntoProgramResource(programResource: Partial<ProgramResource> | undefined = {}): Record<string, (node: ParseNode) => void> {
	return {
		...
		type: (n) => {
			programResource.type = n.getStringValue();
		},
	};
}
/**
...
export function deserializeIntoProvisionedIdentity(provisionedIdentity: Partial<ProvisionedIdentity> | undefined = {}): Record<string, (node: ParseNode) => void> {
	return {
		...
		details: (n) => {
			provisionedIdentity.details = n.getObjectValue<DetailsInfo>(createDetailsInfoFromDiscriminatorValue);
		},
		identityType: (n) => {
			provisionedIdentity.identityType = n.getStringValue();
		},
	};
}
/**
...
export function deserializeIntoProvisioningSystem(provisioningSystem: Partial<ProvisioningSystem> | undefined = {}): Record<string, (node: ParseNode) => void> {
	return {
		...
		details: (n) => {
			provisioningSystem.details = n.getObjectValue<DetailsInfo>(createDetailsInfoFromDiscriminatorValue);
		},
	};
}
/**
...
export function deserializeIntoRetrievalExtract(retrievalExtract: Partial<RetrievalExtract> | undefined = {}): Record<string, (node: ParseNode) => void> {
	return {
		backingStoreEnabled: (n) => {
			retrievalExtract.backingStoreEnabled = true;
		},
		"@odata.type": (n) => {
			retrievalExtract.odataType = n.getStringValue();
		},
		text: (n) => {
			retrievalExtract.text = n.getStringValue();
		},
	};
}
/**
...
export function deserializeIntoRetrievalHit(retrievalHit: Partial<RetrievalHit> | undefined = {}): Record<string, (node: ParseNode) => void> {
	return {
		backingStoreEnabled: (n) => {
			retrievalHit.backingStoreEnabled = true;
		},
		extracts: (n) => {
			retrievalHit.extracts = n.getCollectionOfObjectValues<RetrievalExtract>(createRetrievalExtractFromDiscriminatorValue);
		},
		"@odata.type": (n) => {
			retrievalHit.odataType = n.getStringValue();
		},
		resourceMetadata: (n) => {
			retrievalHit.resourceMetadata = n.getObjectValue<SearchResourceMetadataDictionary>(createSearchResourceMetadataDictionaryFromDiscriminatorValue);
		},
		resourceType: (n) => {
			retrievalHit.resourceType = n.getEnumValue<GroundingEntityType>(GroundingEntityTypeObject);
		},
		sensitivityLabel: (n) => {
			retrievalHit.sensitivityLabel = n.getObjectValue<SearchSensitivityLabelInfo>(createSearchSensitivityLabelInfoFromDiscriminatorValue);
		},
		webUrl: (n) => {
			retrievalHit.webUrl = n.getStringValue();
		},
	};
}
/**
...
export function deserializeIntoRetrievalResponse(retrievalResponse: Partial<RetrievalResponse> | undefined = {}): Record<string, (node: ParseNode) => void> {
	return {
		backingStoreEnabled: (n) => {
			retrievalResponse.backingStoreEnabled = true;
		},
		"@odata.type": (n) => {
			retrievalResponse.odataType = n.getStringValue();
		},
		retrievalHits: (n) => {
			retrievalResponse.retrievalHits = n.getCollectionOfObjectValues<RetrievalHit>(createRetrievalHitFromDiscriminatorValue);
		},
	};
}
/**
...
export function deserializeIntoSearchSensitivityLabelInfo(searchSensitivityLabelInfo: Partial<SearchSensitivityLabelInfo> | undefined = {}): Record<string, (node: ParseNode) => void> {
	return {
		backingStoreEnabled: (n) => {
			searchSensitivityLabelInfo.backingStoreEnabled = true;
		},
		color: (n) => {
			searchSensitivityLabelInfo.color = n.getStringValue();
		},
		displayName: (n) => {
			searchSensitivityLabelInfo.displayName = n.getStringValue();
		},
		isEncrypted: (n) => {
			searchSensitivityLabelInfo.isEncrypted = n.getBooleanValue();
		},
		"@odata.type": (n) => {
			searchSensitivityLabelInfo.odataType = n.getStringValue();
		},
		priority: (n) => {
			searchSensitivityLabelInfo.priority = n.getNumberValue();
		},
		sensitivityLabelId: (n) => {
			searchSensitivityLabelInfo.sensitivityLabelId = n.getStringValue();
		},
		tooltip: (n) => {
			searchSensitivityLabelInfo.tooltip = n.getStringValue();
		},
	};
}
/**
...
export function deserializeIntoServicePrincipalIdentity(servicePrincipalIdentity: Partial<ServicePrincipalIdentity> | undefined = {}): Record<string, (node: ParseNode) => void> {
	return {
		...
		appId: (n) => {
			servicePrincipalIdentity.appId = n.getStringValue();
		},
	};
}
/**
...
export function deserializeIntoSharePointIdentity(sharePointIdentity: Partial<SharePointIdentity> | undefined = {}): Record<string, (node: ParseNode) => void> {
	return {
		...
		loginName: (n) => {
			sharePointIdentity.loginName = n.getStringValue();
		},
	};
}
/**
...
export function deserializeIntoSharePointIdentitySet(sharePointIdentitySet: Partial<SharePointIdentitySet> | undefined = {}): Record<string, (node: ParseNode) => void> {
	return {
		...
		group: (n) => {
			sharePointIdentitySet.group = n.getObjectValue<Identity>(createIdentityFromDiscriminatorValue);
		},
		siteGroup: (n) => {
			sharePointIdentitySet.siteGroup = n.getObjectValue<SharePointIdentity>(createSharePointIdentityFromDiscriminatorValue);
		},
		siteUser: (n) => {
			sharePointIdentitySet.siteUser = n.getObjectValue<SharePointIdentity>(createSharePointIdentityFromDiscriminatorValue);
		},
	};
}
/**
...
export function deserializeIntoSourceProvisionedIdentity(sourceProvisionedIdentity: Partial<SourceProvisionedIdentity> | undefined = {}): Record<string, (node: ParseNode) => void> {
	return {
		...
		identityType: (n) => {
			sourceProvisionedIdentity.identityType = n.getStringValue();
		},
	};
}
/**
...
export function deserializeIntoTargetProvisionedIdentity(targetProvisionedIdentity: Partial<TargetProvisionedIdentity> | undefined = {}): Record<string, (node: ParseNode) => void> {
	return {
		...
		identityType: (n) => {
			targetProvisionedIdentity.identityType = n.getStringValue();
		},
	};
}
/**
...
export function deserializeIntoTeamworkApplicationIdentity(teamworkApplicationIdentity: Partial<TeamworkApplicationIdentity> | undefined = {}): Record<string, (node: ParseNode) => void> {
	return {
		...
		applicationIdentityType: (n) => {
			teamworkApplicationIdentity.applicationIdentityType = n.getEnumValue<TeamworkApplicationIdentityType>(TeamworkApplicationIdentityTypeObject);
		},
	};
}
/**
...
export function deserializeIntoTeamworkConversationIdentity(teamworkConversationIdentity: Partial<TeamworkConversationIdentity> | undefined = {}): Record<string, (node: ParseNode) => void> {
	return {
		...
		conversationIdentityType: (n) => {
			teamworkConversationIdentity.conversationIdentityType = n.getEnumValue<TeamworkConversationIdentityType>(TeamworkConversationIdentityTypeObject);
		},
	};
}
/**
...
export function deserializeIntoTeamworkUserIdentity(teamworkUserIdentity: Partial<TeamworkUserIdentity> | undefined = {}): Record<string, (node: ParseNode) => void> {
	return {
		...
		userIdentityType: (n) => {
			teamworkUserIdentity.userIdentityType = n.getEnumValue<TeamworkUserIdentityType>(TeamworkUserIdentityTypeObject);
		},
		userPrincipalName: (n) => {
			teamworkUserIdentity.userPrincipalName = n.getStringValue();
		},
	};
}
/**
...
export function deserializeIntoUserIdentity(userIdentity: Partial<UserIdentity> | undefined = {}): Record<string, (node: ParseNode) => void> {
	return {
		...
		ipAddress: (n) => {
			userIdentity.ipAddress = n.getStringValue();
		},
		userPrincipalName: (n) => {
			userIdentity.userPrincipalName = n.getStringValue();
		},
	};
}
/**
...
export function deserializeIntoUserInformation(userInformation: Partial<UserInformation> | undefined = {}): Record<string, (node: ParseNode) => void> {
	return {
		...
		accessScope: (n) => {
			userInformation.accessScope = n.getEnumValue<AccessScope>(AccessScopeObject);
		},
		customAttributes: (n) => {
			userInformation.customAttributes = n.getCollectionOfObjectValues<KeyValuePair>(createKeyValuePairFromDiscriminatorValue);
		},
		role: (n) => {
			userInformation.role = n.getEnumValue<MessageUserRole>(MessageUserRoleObject);
		},
	};
}
