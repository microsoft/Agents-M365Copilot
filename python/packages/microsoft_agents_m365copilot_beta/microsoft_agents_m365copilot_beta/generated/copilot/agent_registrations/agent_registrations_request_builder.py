...
if TYPE_CHECKING:
    ...
    from ...models.agent_registration_collection_response import AgentRegistrationCollectionResponse
...
class AgentRegistrationsRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[AgentRegistrationsRequestBuilderGetQueryParameters]] = None) -> Optional[AgentRegistrationCollectionResponse]:
        """
        Navigation property to access agent registrations at /copilot/agentRegistrations.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[AgentRegistrationCollectionResponse]
        """
        ...
        return await self.request_adapter.send_async(request_info, AgentRegistrationCollectionResponse, error_mapping)
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[AgentRegistrationsRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        Navigation property to access agent registrations at /copilot/agentRegistrations.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: RequestInformation
        """
        request_info = RequestInformation(Method.GET, '{+baseurl}/copilot/agentRegistrations{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}', self.path_parameters)
    ...
    def to_post_request_information(self,body: AgentRegistration, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        ...
        if body is None:
            raise TypeError("body cannot be null.")
        request_info = RequestInformation(Method.POST, '{+baseurl}/copilot/agentRegistrations', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
    ...
    @dataclass
    class AgentRegistrationsRequestBuilderGetQueryParameters():
        """
        Navigation property to access agent registrations at /copilot/agentRegistrations.
        """
    ...
    @dataclass
    class AgentRegistrationsRequestBuilderGetRequestConfiguration(RequestConfiguration[AgentRegistrationsRequestBuilderGetQueryParameters]):
        """
