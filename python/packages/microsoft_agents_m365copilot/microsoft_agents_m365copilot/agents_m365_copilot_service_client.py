...
from .generated.base_agents_m365_copilot_service_client import (
    BaseAgentsM365CopilotServiceClient,
)
...
class AgentsM365CopilotServiceClient(BaseAgentsM365CopilotServiceClient):

    def __init__(
        self,
        credentials: Optional[Union[TokenCredential, AsyncTokenCredential]] = None,
        scopes: Optional[List[str]] = None,
        request_adapter: Optional[AgentsM365CopilotRequestAdapter] = None,
    ) -> None:
        ...
        Args:
            ...
            request_adapter (Optional[AgentsM365CopilotRequestAdapter], optional): The request
        ...
        if not request_adapter:
            ...
            request_adapter = AgentsM365CopilotRequestAdapter(auth_provider)
